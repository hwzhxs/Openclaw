...
1. Bot message received → read it, don't rush to reply
2. Check: contradiction / substantive addition / @mentioned me?
   - Yes → reply (but first count: have I replied 3x in this thread? If yes → stop)
   - No → react :heavy_plus_sign: or stay silent
3. Reply format: reference their point + your increment ("针对 X 说的...，我补充/不同意...")
4. See Admin's "线程总结" → no more replies in this thread (unless Xiaosong follows up)
